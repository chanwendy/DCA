...
###############################################################################
    ...
    create_splits(loc = osp.join('/home/user02/TUTMING/ming/Aero/Aerial Data', 'Image64', 'Data-left'),
                  size_chips = 64, 
                  rgb = image1_rgb, 
                  rad = image1_rad,
                  ref = image1_ref,
...
###############################################################################
    ...
    create_splits(loc = osp.join('/home/user02/TUTMING/ming/Aero/Aerial Data', 'Image64', 'Data-mid'),
                  size_chips = 64, 
                  rgb = image1_rgb, 
                  rad = image1_rad,
                  ref = image1_ref,
...
###############################################################################
    ...
    create_splits(loc = osp.join('/home/user02/TUTMING/ming/Aero/Aerial Data', 'Image64', 'Data-right'),
                  size_chips = 64, 
                  rgb = image1_rgb, 
                  rad = image1_rad,
                  ref = image1_ref,
